...
describe("useDownloadButton", function () {
    it("provides full details", function () {
        var result = react_hooks_1.renderHook(function () { return useDownloadButton_1.default(pdfMediaLink, "pdf-title"); }, { wrapper: makeWrapper_1.default().wrapper }).result;
    ...
    it("fixes incorrect adobe mimeType", function () {
        ...
        var result = react_hooks_1.renderHook(function () { return useDownloadButton_1.default(pdfMediaLink, "pdf-title"); }, {
    ...
    it("correctly maps all direct media types", function () {
        var _a, _b, _c, _d;
        var _e = react_hooks_1.renderHook(function (link) {
            return useDownloadButton_1.default(link, "book-title");
        }, {
            wrapper: makeWrapper_1.default().wrapper,
            initialProps: undefined
        }), result = _e.result, rerender = _e.rerender;
        ...
        for (var mediaType in file_1.typeMap) {
            ...
            if (mediaType === interfaces_1.AXIS_NOW_WEBPUB_MEDIA_TYPE ||
                mediaType === interfaces_1.ATOM_MEDIA_TYPE)
                return;
            ...
            chai_1.expect((_c = result.current) === null || _c === void 0 ? void 0 : _c.mimeType).to.equal(mediaType);
            chai_1.expect(typeof ((_d = result.current) === null || _d === void 0 ? void 0 : _d.fulfill)).to.equal("function");
        }
    });
    it("provides correct details for ATOM type", function () {
        var link = {
            url: "/media-url",
            type: "application/atom+xml;type=entry;profile=opds-catalog",
            indirectType: 'text/html;profile="http://librarysimplified.org/terms/profiles/streaming-media"'
        };
        var result = react_hooks_1.renderHook(function () { return useDownloadButton_1.default(link, "pdf-title"); }, {
            wrapper: makeWrapper_1.default().wrapper
        }).result;
    ...
    it("returns null when link is undefined", function () {
        var result = react_hooks_1.renderHook(function () { return useDownloadButton_1.default(undefined, "book-title"); }, {
            wrapper: makeWrapper_1.default().wrapper
        }).result;
        chai_1.expect(result.current).to.equal(null);
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    result = react_hooks_1.renderHook(function () { return useDownloadButton_1.default(pdfMediaLink, "book-title"); }, {
                        wrapper: wrapper
                    }).result;
                    // call fulfill
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    result = react_hooks_1.renderHook(function () { return useDownloadButton_1.default(indirectLink, "indirect-book-title"); }, {
                        wrapper: wrapper
                    }).result;
                    // call fulfill
                    return [4 /*yield*/, result.current.fulfill()];
