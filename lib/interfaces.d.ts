...
export declare const ATOM_MEDIA_TYPE = "text/html;profile=\"http://librarysimplified.org/terms/profiles/streaming-media\"";
export declare const AXIS_NOW_WEBPUB_MEDIA_TYPE = "application/vnd.librarysimplified.axisnow+json";
export declare type ReadOnlineMediaType = typeof ATOM_MEDIA_TYPE | typeof AXIS_NOW_WEBPUB_MEDIA_TYPE;
export declare type MediaType = "application/epub+zip" | "application/kepub+zip" | "application/pdf" | "application/vnd.adobe.adept+xml" | "vnd.adobe/adept+xml" | "application/x-mobipocket-ebook" | "application/x-mobi8-ebook" | "application/atom+xml;type=entry;profile=opds-catalog" | "application/audiobook+json" | "application/vnd.overdrive.circulation.api+json;profile=audiobook" | "application/vnd.overdrive.circulation.api+json;profile=ebook" | ReadOnlineMediaType;
