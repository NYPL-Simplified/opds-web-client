...
describe("OPDSDataAdapter", function () {
    it("extracts book info", function () {
        ...
        chai_1.expect((_k = book.allBorrowLinks) === null || _k === void 0 ? void 0 : _k[0].url).to.equal(borrowLink.href);
        chai_1.expect((_l = book.fulfillmentLinks) === null || _l === void 0 ? void 0 : _l[0].url).to.equal(fulfillmentLink.href);
        chai_1.expect((_m = book.fulfillmentLinks) === null || _m === void 0 ? void 0 : _m[0].type).to.equal(fulfillmentLink.type);
        chai_1.expect((_o = book.fulfillmentLinks) === null || _o === void 0 ? void 0 : _o[0].indirectType).to.equal(fulfillmentLink.indirectAcquisitions[0].type);
