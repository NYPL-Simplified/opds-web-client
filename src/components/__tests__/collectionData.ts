...
let ungroupedCollectionData: CollectionProps = Object.assign({}, groupedCollectionData);
ungroupedCollectionData.books = ungroupedCollectionData.lanes.reduce((results, lane) => {
