...
describe("BookDetails", () => {
  ...
  it("shows contributors", () => {
    let contributor = TestUtils.findRenderedDOMComponentWithClass(renderedBook, "bookDetailsContributors");
    expect(contributor.textContent).toEqual("Contributors: " + book.contributors.join(", "));
  });
