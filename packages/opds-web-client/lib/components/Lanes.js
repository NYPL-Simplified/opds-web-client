        ...
        return (React.createElement("div", { className: "lanes" },
            this.props.isFetching &&
                React.createElement("div", { className: "spinner" },
                    React.createElement("img", { src: spinner_1.default })),
            this.props.lanes && this.props.lanes.length > 0 ?
                React.createElement("ul", { "aria-label": "groups of books", className: "subtle-list" }, this.props.lanes && this.props.lanes.map(function (lane, index) {
                    return React.createElement("li", { key: index },
                        React.createElement(Lane_1.default, { lane: lane, collectionUrl: _this.props.url, hideMoreLink: _this.props.hideMoreLinks, hiddenBookIds: _this.props.hiddenBookIds, updateBook: _this.props.updateBook, fulfillBook: _this.props.fulfillBook, indirectFulfillBook: _this.props.indirectFulfillBook, isSignedIn: _this.props.isSignedIn, epubReaderUrlTemplate: _this.props.epubReaderUrlTemplate }));
                })) : null));
    };
