...
describe("Collection", function () {
    ...
    describe("empty collection", function () {
        it("says the collection is empty", function () {
            var collectionData = Object.assign({}, collectionData_1.groupedCollectionData, { lanes: [] });
            var wrapper = enzyme_1.shallow(React.createElement(Collection_1.default, { collection: collectionData, updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook, setPreference: setPreference }));
    ...
    describe("collection with lanes", function () {
        ...
        var wrapper;
        beforeEach(function () {
            wrapper = enzyme_1.shallow(React.createElement(Collection_1.default, { collection: collectionData, updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook, setPreference: setPreference }));
        });
    ...
    describe("collection without lanes", function () {
        ...
        it("shows grid or list view", function () {
            ...
            wrapper = enzyme_1.mount(React.createElement(Collection_1.default, { collection: collectionData, updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook, setPreference: setPreference }), { context: context,
                childContextTypes: {
    ...
    describe("collection with next page", function () {
        ...
        it("fetches next page on scroll to bottom", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        it("fetches next page if first page doesn't fill window", function () { return __awaiter(_this, void 0, void 0, function () {
            var fetchPage, collectionData, context, wrapper, main;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("fetches next page if newly loaded page doesn't fill window", function () { return __awaiter(_this, void 0, void 0, function () {
            var fetchPage, collectionData, context, wrapper, main;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("shows loading indicator for next page", function () {
            ...
            var wrapper = enzyme_1.shallow(React.createElement(Collection_1.default, { collection: collectionData, isFetchingPage: true, updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook, setPreference: setPreference }));
        ...
        it("contains next page button", function () {
            ...
            var wrapper = enzyme_1.shallow(React.createElement(Collection_1.default, { collection: collectionData, isFetchingPage: false, fetchPage: fetchPage, updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook, setPreference: setPreference }));
