...
describe("BookDetails", function () {
    var wrapper;
    beforeEach(function () {
        wrapper = enzyme_1.shallow(React.createElement(BookDetails_1.default, { book: book, updateBook: sinon_1.stub(), fulfillBook: sinon_1.stub(), indirectFulfillBook: sinon_1.stub(), epubReaderUrlTemplate: sinon_1.stub().returns("test reader url") }));
    });
    ...
    it("shows authors", function () {
        ...
        chai_1.expect(author.text()).to.equal("By " + book.authors.join(", "));
    });
    it("shows contributors", function () {
        var contributor = wrapper.find(".contributors");
        chai_1.expect(contributor.text()).to.equal("Contributors: " + book.contributors.join(", "));
    });
    ...
    it("doesn't show publisher when there isn't one", function () {
        ...
        wrapper = enzyme_1.shallow(React.createElement(BookDetails_1.default, { book: bookCopy, updateBook: sinon_1.stub(), fulfillBook: sinon_1.stub(), indirectFulfillBook: sinon_1.stub() }));
        var publisher = wrapper.find(".publisher");
    ...
    it("shows borrow/hold button", function () {
        ...
        wrapper = enzyme_1.shallow(React.createElement(BookDetails_1.default, { book: bookCopy, updateBook: updateBook, fulfillBook: sinon_1.stub(), indirectFulfillBook: sinon_1.stub() }));
    ...
    it("shows fulfill button if there's no download button", function () {
        ...
        wrapper = enzyme_1.shallow(React.createElement(BookDetails_1.default, { book: bookCopy, updateBook: sinon_1.stub(), fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook, isSignedIn: false }));
