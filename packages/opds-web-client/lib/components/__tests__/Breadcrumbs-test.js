...
describe("Breadcrumbs", function () {
    ...
    it("shows links with bootstrap classes", function () {
        ...
        chai_1.expect(list.hasClass("breadcrumb")).to.equal(true);
...
describe("hierarchyComputeBreadcrumbs", function () {
    ...
    it("returns only collection link without root or parent", function () {
        chai_1.expect(Breadcrumbs_1.hierarchyComputeBreadcrumbs(collection, history)).to.deep.equal([collectionLink]);
    });
    it("returns root and collection if parent not present", function () {
        ...
        chai_1.expect(Breadcrumbs_1.hierarchyComputeBreadcrumbs(data, history)).to.deep.equal([catalogRootLink, collectionLink]);
    });
    ...
    it("returns only parent and collection if root not present", function () {
        ...
        chai_1.expect(Breadcrumbs_1.hierarchyComputeBreadcrumbs(data, history)).to.deep.equal([parentLink, collectionLink]);
    });
    ...
    it("return only root and parent if collection is same as parent", function () {
        ...
        var data = Object.assign({}, collection, { catalogRootLink: catalogRootLink, parentLink: parentLink });
        chai_1.expect(Breadcrumbs_1.hierarchyComputeBreadcrumbs(data, history)).to.deep.equal([catalogRootLink, parentLink]);
    });
