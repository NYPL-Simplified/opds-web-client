...
describe("Lanes", function () {
    ...
    it("fetches collection on mount", function () {
        ...
        wrapper = enzyme_1.shallow(React.createElement(Lanes_1.Lanes, { url: collectionData_1.groupedCollectionData.url, lanes: [], fetchCollection: fetchCollection, updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook }));
    ...
    it("fetches new collection on componentWillReceiveProps if there's a new url", function () {
        ...
        var fetchCollection = sinon_1.stub();
        wrapper = enzyme_1.shallow(React.createElement(Lanes_1.Lanes, { url: "test1", lanes: [], clearCollection: clearCollection, fetchCollection: fetchCollection, updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook }));
    ...
    it("clears collection on unmount", function () {
        var clearCollection = sinon_1.stub();
        wrapper = enzyme_1.shallow(React.createElement(Lanes_1.Lanes, { url: collectionData_1.groupedCollectionData.url, lanes: [], clearCollection: clearCollection, updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook }));
