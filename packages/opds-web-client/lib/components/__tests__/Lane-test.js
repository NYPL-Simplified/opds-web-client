...
describe("Lane", function () {
    ...
    describe("rendering", function () {
        beforeEach(function () {
            wrapper = enzyme_1.shallow(React.createElement(Lane_1.default, { lane: laneData, collectionUrl: "test collection", updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook }));
        });
        it("shows the lane title in a CatalogLink", function () {
            var titleLink = wrapper.find(CatalogLink_1.default);
            chai_1.expect(titleLink.first().children().get(0)).to.equal(laneData.title);
        });
    ...
    describe("behavior", function () {
        beforeEach(function () {
            ...
            wrapper = enzyme_1.mount(React.createElement(Lane_1.default, { lane: laneData, collectionUrl: "test collection", updateBook: updateBook, fulfillBook: fulfillBook, indirectFulfillBook: indirectFulfillBook }), {
                context: context,
                childContextTypes: {
