    ...
    ErrorMessage.prototype.render = function () {
        return (React.createElement("div", { className: "error", role: "dialog", "aria-labelledby": "error" },
            React.createElement("div", null,
                ...
                this.props.retry &&
                    React.createElement("button", { className: "retry-button btn btn-default", onClick: this.props.retry }, "Try again"),
                this.props.close &&
                    React.createElement("button", { className: "close-button btn btn-default", onClick: this.props.close }, "Close"))));
    };
