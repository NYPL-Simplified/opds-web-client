...
var Collection = /** @class */ (function (_super) {
            ...
            React.createElement("div", { className: "collection-container" },
                ...
                React.createElement("div", { id: "collection-main", className: "collection-main", ref: "collection-main", "aria-label": "books in " + this.props.collection.title },
                    (this.props.collection.lanes && this.props.collection.lanes.length > 0) ?
                        React.createElement(Lanes_1.Lanes, { url: this.props.collection.url, lanes: this.props.collection.lanes, updateBook: this.props.updateBook, fulfillBook: this.props.fulfillBook, indirectFulfillBook: this.props.indirectFulfillBook, isSignedIn: this.props.isSignedIn, epubReaderUrlTemplate: this.props.epubReaderUrlTemplate }) : null,
                    this.props.collection.books &&
                        React.createElement("ul", { "aria-label": "books", className: "subtle-list books " + this.getSelectedView() }, this.props.collection.books.map(function (book, index) {
                            return React.createElement("li", { key: index },
                                React.createElement(Book_1.default, { book: book, collectionUrl: _this.props.collection.url, updateBook: _this.props.updateBook, fulfillBook: _this.props.fulfillBook, indirectFulfillBook: _this.props.indirectFulfillBook, isSignedIn: _this.props.isSignedIn, epubReaderUrlTemplate: _this.props.epubReaderUrlTemplate }));
                        })),
                    ...
                    this.isEmpty() &&
                        React.createElement("div", { className: "empty-collection-message" }, "No books found."),
                    this.canFetch() &&
    ...
    Collection.prototype.getSelectedView = function () {
        return (this.props.preferences && this.props.preferences[Collection.VIEW_KEY]) || Collection.GRID_VIEW;
    };
    ...
    Collection.prototype.componentWillReceiveProps = function (nextProps) {
        if (this.props.isFetchingCollection && !nextProps.isFetchingCollection && !nextProps.error) {
