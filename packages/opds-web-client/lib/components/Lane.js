    ...
    Lane.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "lane" },
            ...
            React.createElement("div", { ref: "container", className: "lane-books-container" },
                !this.state.atLeft &&
                    React.createElement("div", { className: "scroll-button left", "aria-label": "Scroll back in " + this.props.lane.title, onClick: this.scrollBack }, "\u25C1"),
                React.createElement("ul", { ref: "list", className: "lane-books", "aria-label": "books in " + this.props.lane.title },
                    visibleBooks.map(function (book, index) {
                        return React.createElement("li", { key: index },
                            React.createElement(Book_1.default, { book: book, collectionUrl: _this.props.collectionUrl, updateBook: _this.props.updateBook, fulfillBook: _this.props.fulfillBook, indirectFulfillBook: _this.props.indirectFulfillBook, isSignedIn: _this.props.isSignedIn, epubReaderUrlTemplate: _this.props.epubReaderUrlTemplate }));
                    }),
                    !this.props.hideMoreLink &&
                        React.createElement("li", { key: "more" },
                            React.createElement(LaneMoreLink_1.default, { lane: this.props.lane }))),
                !this.state.atRight &&
                    React.createElement("div", { className: "scroll-button right", "aria-label": "Scroll forward in " + this.props.lane.title, onClick: this.scrollForward }, "\u25B7"))));
    };
