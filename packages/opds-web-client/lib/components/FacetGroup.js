...
var FacetGroup = /** @class */ (function (_super) {
    ...
    FacetGroup.prototype.render = function () {
        return (React.createElement("div", { className: "facet-group" },
            ...
            React.createElement("ul", { "aria-label": this.props.facetGroup.label + " options", className: "subtle-list" }, this.props.facetGroup.facets.map(function (facet) {
                return React.createElement("li", { key: facet.label, className: facet.active ? "active" : null },
